                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_mahasiswa') is-invalid @enderror"
                            value="{{ old('nama_mahasiswa') ?? $detail->nama_mahasiswa }}" name="nama_mahasiswa"
                            id="nama_mahasiswa">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nim_mahasiswa') is-invalid @enderror"
                            value="{{ old('nim_mahasiswa') ?? $detail->nim_mahasiswa }}" name="nim_mahasiswa"
                            id="nim_mahasiswa">
                        @error('nim_mahasiswa')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-check">
                        <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror" type="radio"
                            ...
                            {{ $detail->jenis_kelamin == 'L' ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror" type="radio"
                            ...
                            {{ $detail->jenis_kelamin == 'P' ? 'checked' : '' }}>
