											...
											<div class="card-body">
												...
												<div class="progress" style="height:5px;">
													<div class="progress-bar bg-success"
														style="width: 100%; height:5px;" aria-label="Progess-success"
														role="progressbar">
											...
											<div class="card-body">
												<div class="media align-items-center">
													<span class="activity-icon bgl-secondary  me-md-4 me-3">
														<i class="bi bi-send-check text-secondary"
															style="font-size: 30px;"></i>
													</span>
													<div class="media-body">
												...
												<div class="progress" style="height:5px;">
													<div class="progress-bar bg-secondary"
														style="width: 100%; height:5px;" aria-label="Progess-secondary"
														role="progressbar">
											...
											<div class="card-body">
												<div class="media align-items-center">
													<span class="activity-icon bgl-danger me-md-4 me-3">
														<i class="bi bi-pencil-square text-danger"
															style="font-size: 30px;"></i>
													</span>
													<div class="media-body">
											...
											<div class="card-body">
												...
												<div class="progress" style="height:5px;">
													<div class="progress-bar bg-warning"
														style="width: 100%; height:5px;" role="progressbar">
										...
										<div class="card">
											<div class="card-body">
												...
												<ul
													...
													<li class="mb-2"><span
															class="fs-14 text-black font-w500">192.168.1.1</span>
													</li>
												</ul>
												<ul
													class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
													...
													<li class="mb-2"><span
															class="fs-14 text-black font-w500">Chrome</span>
													</li>
												</ul>
											</div>
										</div>
